...
public class Lexer {
    ...
    private static Language _globalLanguage = LanguageC.getInstance();
    ...
    private class LexThread extends Thread {
        ...
        public void tokenize2() {
            ...
            Document.Seeker seeker = hDoc.getNewSeeker();
            seeker.seekPosition(0);
            while (seeker.hasNext() && !_abort.isSet()) {
                char currentChar = seeker.next();
...
//TODO consider less greedy approach and avoid adding token for previous char
                    ...
                    default:
                        EditorException.fail("Invalid state in TokenScanner");
                        break;
                }
                ++workingPosition;
    ...
    public interface LexCallback {
        public void onLexDone(List<Pair> results);
    }
}
